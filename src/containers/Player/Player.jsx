...
import { usePrevious } from '../../helpers/custom-hooks';

import './Player.scss';

const Player = () => {
  const [currentTrack, setCurrentTrack] = useState(null);
  const playingNowId = useSelector(state => state.jukebox.playingNowId);
  const playingNowTrack = useSelector(state => state.jukebox.playingNowTrack);
